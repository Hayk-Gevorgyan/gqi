...
<template>
	<div class="relative flex items-center gap-2 bg-gray1 px-2 py-1.5" @keydown.esc="closeSearchPanel(view)">
		...
		/>
		<Button size="tiny" @click.prevent="findNext(view)">Next</Button>
		<Button size="tiny" @click.prevent="findPrevious(view)">Previous</Button>
		<Button size="tiny" @click.prevent="selectMatches(view)">All</Button>
